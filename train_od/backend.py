...
class TinyYoloFeature_1(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        ...
        # Layer 1
        x = Conv2D(4, (3, 3), strides=(1, 1), padding='same',
                   name='conv_1', use_bias=False)(input_image)
        x = BatchNormalization(name='norm_1')(x)
        x = LeakyReLU(alpha=0.1)(x)
        x = MaxPooling2D(pool_size=(2, 2))(x)
        ...
        # Layer 2 - 5
        for i in range(0, 4):
            x = Conv2D(8*(2**i), (3, 3), strides=(1, 1), padding='same',
                       name='conv_' + str(i+2), use_bias=False)(x)
            x = BatchNormalization(name='norm_' + str(i+2))(x)
            x = LeakyReLU(alpha=0.1)(x)
            x = MaxPooling2D(pool_size=(2, 2))(x)
...
class TinyYoloFeature_2(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        ...
        # Layer 2 - 5
        for i in range(0, 4):
            x = Conv2D(4*(2**i), (3, 3), strides=(1, 1), padding='same',
                       name='conv_' + str(i+2), use_bias=False)(x)
            x = BatchNormalization(name='norm_' + str(i+2))(x)
            x = LeakyReLU(alpha=0.1)(x)
            x = MaxPooling2D(pool_size=(2, 2))(x)
...
class MobileNetFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        ...
        mobilenet = MobileNet(input_shape=(
            input_height, input_width, input_channel), include_top=False, weights=None)
...
class Inception3Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        ...
        inception = InceptionV3(input_shape=(
            input_height, input_width, input_channel), include_top=False)
...
class VGG16Feature(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        vgg16 = VGG16(input_shape=(input_height, input_width,
                                   input_channel), include_top=False)
...
class MyYoloFeature(BaseFeatureExtractor):
    ...
    def __init__(self, input_height, input_width, input_channel):
        ...
        # Layer 2
        x = Conv2D(32, (1, 1), strides=(1, 1), padding='valid',
                   name='conv_2', use_bias=False)(x)
        x = BatchNormalization(name='norm_2')(x)
        x = LeakyReLU(alpha=0.1)(x)
